...
export const getSummary = async (userId) => {
    ...
    const totalSalesPromise = saleModel.sumByUserIdAndDateRange(userId, startDate, endDate);
    const totalExpensesPromise = expenseModel.sumByUserIdAndDateRange(userId, startDate, endDate);
